// Package database provides functionality to connect and interact with the PostgreSQL database.
package database
...
import (
	...
	loggerConfig "github.com/uttam282005/tasker/internal/logger"
)
